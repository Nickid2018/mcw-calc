...
import { BlockStateModelManager } from '@/tools/blockStructureRendererOld/model.ts'
import {
  bakeBlockMarkers,
...
import { saveAsLitematic, saveAsStructureFile } from '@/tools/blockStructureRendererOld/structure.ts'
import { MaterialPicker } from '@/tools/blockStructureRendererOld/texture.ts'
